...
from flask_admin.tools import ObsoleteAttr
from flask_admin.babel import gettext, ngettext, lazy_gettext
from flask_admin.model import BaseModelView
from flask_admin.actions import action

from flask_admin.contrib.sqlamodel import form, filters, tools
...
class ModelView(BaseModelView):
    ...
    """
        ...
        Can contain either field names or instances of :class:`flask_admin.contrib.sqlamodel.filters.BaseFilter` classes.
